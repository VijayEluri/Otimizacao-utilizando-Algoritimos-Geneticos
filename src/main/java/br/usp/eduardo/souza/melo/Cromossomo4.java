...
public class Cromossomo4 extends ElementoGA {
	// Vetor que armazena o custo adicional por empregado
	public double[] custoAddEmp = { 0.6, 1.3, 0.9, 1.4, 0.3 };

	// Vetores que armazenam as habilidades dos funcionarios
	...
	// Vetor que armazena as caracteristicas ja existentes
	public boolean[] neccompletas = new boolean[necessidades.length];

	public Cromossomo4(int[] elem) {
		super(elem);
	}
	...
	public void calculaAvaliacao() {
		...
		this.avaliacao = 1.0 / (avaliacao * penalidadecar + 1.0) * 100000;
